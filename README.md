...
- **Catalog isn't fixed size anymore** — it started as 8 demo cards with real market
  ...
  the 1950s with real identities, not just modern cards. Every number shown stays
  honestly computed from what's actually there, never padded to look fuller (see
